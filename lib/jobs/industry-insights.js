    ...
    _cronFnPromise = (async () => {
      ...
      return inngest.createFunction(
        ...
        async ({ step }) => {
          ...
          log.info(
            "generate-industry-insights-cron",
          ...
          if (staleIndustries.length === 0) {
            log.info(
              "generate-industry-insights-cron",
              "All industries are fresh — nothing to do",
            );
    ...
    _workerFnPromise = (async () => {
      ...
      return inngest.createFunction(
        ...
        async ({ event, step }) => {
          ...
          log.info("process-industry-insight", "Starting insight refresh", {
            industry,
          });
          ...
          log.info("process-industry-insight", "Insight persisted", {
            industry,
          });
