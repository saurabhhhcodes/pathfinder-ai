 ...
 */
export const careerRoadmapOutputSchema = z
  .object({
    milestones: z
      .array(
        z
 ...
 */
export const skillGapAnalysisOutputSchema = z
  .object({
...
export const founderReadinessOutputSchema = z
  .object({
...
export const executivePresenceOutputSchema = z
  .object({
    personaSummary: z.string().min(20).max(1000),
    communicationUpgrades: z
      .array(
        z
          .object({
...
export const sideHustleIdeaOutputSchema = z
  .object({
    ideas: z
      .array(
        z
...
export const remoteWorkPitchOutputSchema = z
  .object({
...
export const managerReadmeOutputSchema = z
  .object({
    readmeMarkdown: z.string().min(50).max(5000),
  })
  .strict();

export const imposterSyndromeOutputSchema = z
  .object({
