...
const MENU_GROUPS = [
  {
    ...
    items: [
      ...
      },
      {
        href: "/ats-analyzer",
        label: "ATS Analyzer",
        icon: <ScanSearch className="h-4 w-4 text-blue-500" />,
        shortcut: "",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: <ScanSearch className="h-4 w-4 text-[#0A66C2]" />,
        shortcut: "",
      },
      {
        href: "/linkedin-post",
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/interview/star-builder",
        label: "STAR Builder",
        icon: <Star className="h-4 w-4 text-yellow-500" />,
        shortcut: "",
      },
      {
        href: "/interview/cheat-sheet",
        label: "Cheat Sheet",
        icon: <FileSearch className="h-4 w-4 text-zinc-500" />,
        shortcut: "",
      },
      {
        href: "/behavioral-prep",
    ...
    items: [
      {
        href: "/job-tracker",
        label: "Job Tracker",
        icon: <LayoutList className="h-4 w-4 text-green-500" />,
        shortcut: "",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        href: "/promotion-negotiator",
        label: "Promotion Coach",
      ...
      {
        href: "/freelance-proposal",
        label: "Freelance Proposals",
        icon: <FileSignature className="h-4 w-4 text-teal-500" />,
        shortcut: "",
      },
      {
        href: "/explore",
      ...
      {
        href: "/layoff-strategist",
        label: "Layoff Strategist",
      ...
      {
        href: "/career-break",
        label: "Sabbatical Planner",
        icon: <CalendarHeart className="h-4 w-4 text-violet-500" />,
        shortcut: "",
      },
      {
        href: "/visa-guide",
      ...
      {
        href: "/relocation",
        label: "Relocation Analyzer",
        icon: <MapPin className="h-4 w-4 text-orange-500" />,
        shortcut: "",
      },
      {
        href: "/mentor-matcher",
        label: "Mentor Matcher",
        icon: <Users className="h-4 w-4 text-cyan-500" />,
        shortcut: "",
      },
      {
        href: "/toxic-workplace",
        label: "Toxic Workplace Escape",
...
export default function AppSidebar() {
          ...
          <div className="relative shrink-0">
            <ClerkUserButton
              appearance={{
                elements: {
                  avatarBox:
                    "w-9 h-9 rounded-xl ring-2 ring-primary/10 group-hover:ring-primary/30 transition-all shadow-lg",
                },
              }}
            />
          </div>
  ...
  return (
    <>
      ...
      >
        <div className="h-full w-full overflow-hidden">{sidebarContent}</div>
      </motion.div>
    </>
  );
}
