...
export function ResumeShowcase() {
  ...
  return (
    <section
      ref={ref}
      id="resume-showcase"
      className="relative py-20 sm:py-24 md:py-32 lg:py-40 bg-muted/30 overflow-hidden"
    >
      <div className="container mx-auto px-4 md:px-6">
        <FadeUp className="max-w-3xl mx-auto text-center mb-20 space-y-4">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground">
            ATS-Optimized <span className="text-gradient-primary">Resumes</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Premium templates designed to pass automated screenings and impress
            hiring managers.
          </p>
        </FadeUp>
          ...
          <div className="space-y-6">
            <FadeUp delay={0.2}>
              ...
              <p className="text-muted-foreground leading-relaxed mt-3">
                Our AI analyzes thousands of job descriptions to optimize your
                resume for each application. Every section, keyword, and bullet
                point is strategically placed.
              </p>
            </FadeUp>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                },
                {
                  ...
                  value: "96%",
                  color: "text-chart-1",
                  desc: "Aligned with job descriptions",
                },
                {
                  label: "Format Score",
                  value: "100%",
                ...
                },
                {
                  ...
                  value: "A+",
                  color: "text-chart-5",
                  desc: "Clear & scannable",
                },
              ].map((stat) => (
                <FadeUp key={stat.label} delay={0.3}>
                  <TiltCard
                    className="glass rounded-xl p-4 border border-border/30 text-center hover:border-primary/30 transition-all duration-300"
                    tiltDegree={5}
                  >
