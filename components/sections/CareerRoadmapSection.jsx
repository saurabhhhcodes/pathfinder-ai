          ...
          <svg viewBox="0 0 500 365" className="w-full h-auto">
            ...
            {milestones.map((m, i) => (
              ...
              >
                ...
                >
                  <div
                    className={`flex flex-col items-center justify-center p-2 rounded-xl bg-card/80 backdrop-blur-md shadow-lg border transition-all duration-300 pointer-events-none ${hovered === i ? "border-primary/50" : "border-border/30"}`}
                  >
