    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-md">
          Start adding job applications to your tracker to see your analytics
          and insights here.
        </p>
        <Link
          href="/job-tracker"
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-10 space-y-8">
      <div className="flex items-center gap-4">
        <Link
          href="/job-tracker"
          aria-label="Back to job tracker"
        ...
        <div>
          ...
          <p className="text-muted-foreground font-medium">
            Insights into your job hunt pipeline.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-6 bg-card border border-border rounded-3xl shadow-sm flex flex-col gap-2">
          ...
          <h3 className="text-4xl font-black">
            {data.uniqueCompanyCount ?? data.companyData.length}
          </h3>
        </div>
      </div>
