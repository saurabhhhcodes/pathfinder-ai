  ...
  const handleParseUrl = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        const { companyName, jobTitle, location, salary, jobDescription } =
          res.data;
        ...
        if (baseResume && jobDescription) {
          const existingAnalysis = atsAnalyses.find(
            (a) =>
                  ...
                  >
                    ...
                    {atsAnalyses.map((a) => (
                      <option key={a.id} value={a.id}>
                        {a.jobTitle || "Untitled"} @{" "}
                        {a.companyName || "Unknown"} (Score: {a.atsScore})
                      </option>
                    ))}
                  </select>
                </div>
