    ...
    <div className="w-[100px] h-[140px] bg-background border border-border rounded-xl p-3 flex flex-col gap-2 shadow-sm overflow-hidden transition-transform duration-500 group-hover:scale-105">
      <div
        className={cn(
          ...
          type === "resume" ? "bg-blue-500/20" : "bg-primary/20",
        )}
      />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Premium layouts powered by AI precision.
          </p>
        </div>
      ...
      <AnimatePresence>
        {selected && (
          ...
          >
            <div className="flex items-center gap-4 text-center sm:text-left">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Proceed to build your{" "}
                  {TEMPLATES.find((t) => t.id === selected)?.type === "resume"
                    ? "resume"
                    : "cover letter"}{" "}
                  with AI filling.
                </p>
            ...
            <Link
              href={TEMPLATES.find((t) => t.id === selected)?.href || "#"}
