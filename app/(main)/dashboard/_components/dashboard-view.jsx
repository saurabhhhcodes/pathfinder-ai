      ...
      <div className="flex flex-wrap gap-1.5 mt-3">
        {citations.map((citation) => (
          ...
          >
            <Badge
              variant="outline"
              className="rounded-full text-[10px] font-bold py-0 h-5 border-border/50 bg-muted/30 group-hover/link:bg-primary/10 group-hover/link:text-primary group-hover/link:border-primary/30 transition-all"
            >
        ...
        {[
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div
                className={`h-10 w-10 rounded-xl flex items-center justify-center ${metric.color}`}
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="rounded-[2.5rem] border-border shadow-lg overflow-hidden flex flex-col">
          <CardHeader className="p-8 pb-4">
            ...
            <CardDescription>
              Visualizing your resume optimization journey over time.
            </CardDescription>
          </CardHeader>
            ...
            {chartData.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground max-w-[200px]">
                  No scans yet. Start by optimizing your first resume!
                </p>
              </div>
            )}
          </CardContent>
        ...
        <Card className="rounded-[2.5rem] border-border shadow-lg overflow-hidden flex flex-col">
          <CardHeader className="p-8 pb-4 flex flex-row items-start justify-between">
            <div>
              ...
              <CardDescription>
                Competitive intelligence for your role.
              </CardDescription>
            </div>
            ...
            {insights?.salaryRanges?.length > 0 ? (
              <>
                          ...
                          if (active && payload && payload.length) {
                            ...
                            return (
                              <div className="glass p-4 rounded-2xl border border-white/20 shadow-xl text-xs max-w-[240px]">
                                <p className="font-black text-foreground mb-1 truncate">
                                  {data.role}
                                </p>
                                <div className="space-y-1 mb-2">
                                  ...
                                  <p className="text-muted-foreground flex justify-between text-[10px]">
                                    Range:{" "}
                                    <span>
                ...
                <div className="space-y-3 max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
                  {insights.salaryRanges.map((data, i) => (
                    <div
                      key={i}
                      className="group p-4 rounded-2xl border border-border bg-muted/30 hover:bg-muted transition-colors"
                    >
              ...
              <div className="flex flex-col items-center justify-center h-full text-center py-10">
                <p className="text-sm text-muted-foreground">
                  Industry data is currently unavailable.
                </p>
              </div>
            )}
          </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Card className="rounded-[2.5rem] border-border shadow-lg">
          <CardHeader className="p-8">
            ...
            <CardDescription>
              Top in-demand skills for your current industry profile.
            </CardDescription>
          </CardHeader>
            ...
            <div className="flex flex-wrap gap-2">
              {insights?.topSkills?.map((skill, i) => (
                ...
                >
                  <Badge
                    variant="secondary"
                    className="px-4 py-2 rounded-xl border border-border bg-muted/50 hover:bg-primary/10 hover:text-primary hover:border-primary/20 transition-all cursor-default text-sm font-bold"
                  >
                    {skill}
                  </Badge>
                </motion.div>
        ...
        <Card className="rounded-[2.5rem] border-border shadow-lg bg-primary/[0.02]">
          <CardHeader className="p-8">
            ...
            <CardDescription>
              AI-generated perspective on market trends.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-8 pt-0">
            <div className="relative p-6 rounded-3xl bg-background border border-border shadow-inner">
              <p className="text-sm text-muted-foreground leading-relaxed italic">
                ...
                {insights?.marketOutlook ||
                  "Maintain focus on skill acquisition to remain competitive in an evolving marketplace."}
                "
              </p>
