  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        desc: "Micro-SaaS & Solopreneur",
        icon: Rocket,
        color: "bg-cyan-500/10 text-cyan-500 border-cyan-500/20",
        href: "/side-hustle",
      },
      {
        name: "Remote Work Negotiator",
        desc: "Pitch remote transition",
        icon: Home,
        color: "bg-emerald-500/10 text-emerald-500 border-emerald-500/20",
        href: "/remote-work",
      },
              ...
              {category.tools.map((tool, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div
                        className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border ${tool.color}`}
                      >
