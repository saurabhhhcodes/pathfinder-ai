        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm md:text-base font-medium">
              Turn your achievements into engaging, recruiter-magnet LinkedIn
              posts.
            </p>
          </div>
        </motion.div>
              ...
              <form onSubmit={handleGenerate} className="space-y-5">
                <div className="space-y-2">
                  <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider ml-1 flex items-center gap-1.5">
                    <MessageSquareText className="h-3.5 w-3.5" /> Topic or
                    Milestone
                  </label>
                  <Textarea
            ...
            {activePosts ? (
              ...
              >
                {activePosts.map((post, idx) => (
                  <div
                    key={idx}
                    className="bg-card border border-border p-6 rounded-3xl shadow-md"
                  >
              ...
              <div className="h-full flex items-center justify-center p-12 border-2 border-dashed border-border rounded-3xl text-center">
                <div className="max-w-md space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Enter a milestone on the left, and the AI will generate 3
                    highly engaging posts with hooks, emojis, and hashtags ready
                    for LinkedIn.
                  </p>
                </div>
              </div>
