    ...
    <div className="container max-w-6xl py-12 px-4 md:px-6 min-h-screen flex flex-col">
      <div className="space-y-4 mb-8">
        ...
        <h1 className="text-3xl md:text-4xl font-black tracking-tight text-foreground">
          Practice Your{" "}
          <span className="text-gradient-primary">Networking.</span>
        </h1>
      </div>
        ...
        <div className="lg:col-span-3 glass rounded-3xl border border-border flex flex-col">
          {currentSession ? (
            <>
              ...
              <div className="p-4 border-b border-border bg-background/50 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {currentSession.targetRole} in {currentSession.industry}
                  </p>
                </div>
              ...
              {/* Chat Area */}
              <div
                className="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar bg-gradient-to-b from-background/50 to-background/20"
              ...
              >
                ...
                {currentSession.feedback && (
                  <motion.div
                    ...
                    className="mt-8 p-6 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl"
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <Award className="h-6 w-6 text-emerald-500" />
                      <h3 className="text-lg font-bold text-emerald-500">
                        Feedback Session Complete (Score:{" "}
                        {currentSession.feedback.overallScore}/100)
                      </h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <h4 className="text-xs font-bold uppercase tracking-widest text-emerald-500">
                          Strengths
                        </h4>
                      ...
                      <div className="space-y-2">
                        ...
                        <ul className="space-y-1">
                          {currentSession.feedback.areasForImprovement.map(
                            (s, i) => (
                              <li
                                key={i}
                                className="text-sm text-muted-foreground flex items-start gap-2"
              ...
              <div className="max-w-md w-full space-y-6">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Set up a mock informational interview with an AI executive.
                  </p>
                </div>
