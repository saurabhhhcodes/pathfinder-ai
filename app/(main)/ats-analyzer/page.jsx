        ...
        <div className="space-y-4 mb-12">
          ...
          <div>
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-foreground flex items-center gap-4">
              ...
              ATS{" "}
              <span className="text-gradient-primary">Compatibility Hub</span>
            </h1>
            <p className="text-muted-foreground text-sm md:text-base font-medium mt-2 max-w-2xl">
              Optimize your reach. Benchmark your resume against real-world job
              descriptions using our advanced neural scoring engine.
            </p>
          </div>
        </div>
