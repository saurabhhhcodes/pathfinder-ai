    ...
    <div className="container max-w-6xl py-12 px-4 md:px-6">
      <div className="space-y-4 mb-10 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-black tracking-tight text-foreground">
          Pause Gracefully,{" "}
          <span className="text-gradient-primary">Return Strong.</span>
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Whether you're taking time off for family, health, or travel, we'll
          help you plan a graceful exit, stay relevant during your break, and
          explain the gap confidently when you return.
        </p>
      </div>
                ...
                {history.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <CalendarHeart
                        className={`h-4 w-4 shrink-0 ${currentPlan?.id === item.id ? "text-violet-500" : "text-muted-foreground"}`}
                      />
            ...
            {currentPlan ? (
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div className="p-6 glass rounded-3xl border border-violet-500/30 bg-violet-500/5 relative">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        copyToClipboard(currentPlan.planData.resumeExplanation)
                      }
                    >
                      Copy for Resume
                    </Button>
                  ...
                  <div className="p-6 glass rounded-3xl border border-[#0A66C2]/30 bg-[#0A66C2]/5 relative">
                    ...
                    <Button
                      ...
                      className="mt-4 rounded-xl"
                      onClick={() =>
                        copyToClipboard(currentPlan.planData.linkedinHeadline)
                      }
                    >
                      Copy for LinkedIn
                    </Button>
                ...
                <div className="p-6 glass rounded-3xl border border-emerald-500/30 bg-emerald-500/5">
                  ...
                  <div className="bg-background/60 p-4 rounded-2xl border border-emerald-500/20">
                    <p className="text-xs font-bold uppercase text-emerald-500 mb-2">
                      When they ask about the gap:
                    </p>
                    <p className="text-sm text-foreground italic">
                      "{currentPlan.planData.interviewScript}"
                    </p>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center p-8 glass rounded-3xl border border-dashed border-border">
                ...
                <p className="text-sm text-muted-foreground/60 max-w-sm mt-2">
                  Fill out the form to confidently plan your sabbatical and
                  future return.
                </p>
              </div>
            )}
