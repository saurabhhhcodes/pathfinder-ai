        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm md:text-base font-medium">
              Paste a job description and the AI will craft a perfectly
              tailored, downloadable PDF resume.
            </p>
          </div>
        </motion.div>
            ...
            {activeResume ? (
              !isValidResume(activeResume) ? (
                <div className="h-full flex items-center justify-center p-12 border border-destructive/20 bg-destructive/5 rounded-3xl text-center">
                  <div className="max-w-md space-y-4">
                    ...
                    <p className="text-muted-foreground text-sm">
                      The loaded or generated resume data contains invalid
                      fields or is corrupted. Please try generating a new one.
                    </p>
                  </div>
                </div>
              ) : (
                ...
                >
                  <div className="flex justify-end">
                    <Button
                      onClick={downloadPDF}
                      className="bg-green-500 hover:bg-green-600 text-white rounded-xl font-bold shadow-lg shadow-green-500/20"
                    >
                  ...
                  <div className="bg-white text-black p-8 md:p-12 rounded-lg shadow-xl overflow-x-auto print:shadow-none print:p-0">
                    ...
                    <div
                      ref={resumeRef}
                      className="w-[8.5in] min-h-[11in] mx-auto bg-white"
                      style={{ fontFamily: "Arial, sans-serif" }}
                    >
                      {/* Header */}
                      <div className="text-center border-b-2 border-black pb-4 mb-4">
                        <h1 className="text-3xl font-serif font-bold uppercase tracking-wide mb-2">
                          {activeResume.personalInfo?.name}
                        </h1>
                      ...
                      {activeResume.summary && (
                        <div className="mb-6">
                          <h2 className="text-sm font-bold uppercase tracking-widest border-b border-gray-300 mb-2 pb-1">
              ...
              <div className="h-full flex items-center justify-center p-12 border-2 border-dashed border-border rounded-3xl text-center">
                <div className="max-w-md space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Paste a job description on the left to instantly generate an
                    ATS-optimized PDF resume based on your profile.
                  </p>
                </div>
              </div>
            )}
