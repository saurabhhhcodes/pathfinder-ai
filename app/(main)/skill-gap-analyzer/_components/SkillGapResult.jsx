    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 space-y-2 text-center md:text-left">
              ...
              <p className="text-muted-foreground">
                Based on your current profile and the target role requirements,
                you have a {matchPercentage}% skill match. Focus on the
                high-priority missing skills to improve your chances.
              </p>
            </div>
          </div>
        </CardContent>
              ...
              {missingSkills?.length > 0 ? (
                missingSkills.map((item, index) => (
                  <Badge
                    key={index}
                    variant="outline"
                    className={`px-3 py-1 border-0 ${getPriorityColor(item.priority)}`}
                  >
                    {item.skill}
                    <span className="ml-2 text-[10px] uppercase opacity-70 font-bold">
                      {item.priority}
                    </span>
                  </Badge>
                ))
                ...
                <p className="text-sm text-muted-foreground">
                  No missing skills found. You're fully prepared!
                </p>
              )}
            </div>
          </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A structured plan to acquire missing skills
          </CardDescription>
        </CardHeader>
        <CardContent>
