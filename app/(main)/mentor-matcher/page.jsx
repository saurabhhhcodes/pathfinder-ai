    ...
    <div className="container max-w-6xl py-12 px-4 md:px-6">
      <div className="space-y-4 mb-10 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Stop asking "Will you be my mentor?" We'll help you identify exactly
          who to look for, write the perfect cold outreach message, and
          structure a 6-month agenda for your 1-on-1s.
        </p>
      </div>
          ...
          <div className="p-6 glass rounded-3xl border border-border">
            ...
            <div className="space-y-4">
              ...
              <Button
                ...
                disabled={
                  isGenerating || !goals.trim() || !targetIndustry.trim()
                }
                ...
                {history.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Target
                        className={`h-4 w-4 shrink-0 ${currentPlan?.id === item.id ? "text-cyan-500" : "text-muted-foreground"}`}
                      />
            ...
            {currentPlan ? (
              ...
              >
                ...
                <div className="p-6 glass rounded-3xl border border-cyan-500/30 bg-cyan-500/5">
                  ...
                  <div className="mt-4 pt-4 border-t border-cyan-500/20">
                    <p className="text-xs font-bold uppercase text-cyan-500 mb-2">
                      Where to find them:
                    </p>
                    <ul className="space-y-2">
                      {currentPlan.outreachData.whereToFindThem.map(
                        (place, idx) => (
                          <li
                            key={idx}
                ...
                <div className="p-6 glass rounded-3xl border border-border relative bg-background/40">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      copyToClipboard(currentPlan.outreachData.outreachMessage)
                    }
                  >
                    Copy Message
                  </Button>
                ...
                <div className="p-6 glass rounded-3xl border border-emerald-500/30 bg-emerald-500/5">
                  ...
                  <div className="space-y-6">
                    {currentPlan.outreachData.sixMonthAgenda.map(
                      (month, idx) => (
                        <div
                          key={idx}
                        ...
                        >
                          ...
                          <div className="space-y-1">
                            {month.questionsToAsk.map((q, qIdx) => (
                              ...
                              >
                                <span className="text-emerald-500/50 mt-0.5">
                                  ↳
                                </span>{" "}
                                {q}
                              </p>
              ...
              <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center p-8 glass rounded-3xl border border-dashed border-border">
                ...
                <p className="text-sm text-muted-foreground/60 max-w-sm mt-2">
                  Enter your goals to find the perfect mentor archetype and
                  outreach strategy.
                </p>
              </div>
            )}
