...
const QUESTION =
  "Tell me about a time when you had to overcome a significant technical challenge at work.";
      ...
      <div className="max-w-4xl mx-auto w-full px-4 md:px-8 py-10 flex flex-col min-h-screen">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium max-w-2xl mx-auto">
            Practice your verbal communication skills. We'll transcribe your
            answer and score it on confidence and filler words.
          </p>
        </motion.div>
        ...
        {!speechSupported ? (
          <div className="bg-red-500/10 border border-red-500/20 text-red-500 p-6 rounded-2xl text-center">
            ...
            <p className="text-sm mt-1">
              Please use a compatible browser like Google Chrome or Microsoft
              Edge.
            </p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-muted/30 p-6 rounded-2xl border border-border flex flex-col justify-center items-center text-center">
                    ...
                    <span
                      className={`text-4xl font-black ${evaluation.fillerWordsCount > 5 ? "text-red-500" : "text-green-500"}`}
                    >
