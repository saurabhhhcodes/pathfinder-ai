    ...
    <div className="container max-w-4xl py-12 px-4 md:px-6">
      <div className="space-y-4 mb-10 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Input your severance details or layoff situation. The AI will decode
          your package, tell you what to negotiate, and build a 30-day recovery
          plan.
        </p>
      </div>
                ...
                {history.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <FileText
                        className={`h-4 w-4 ${currentPlan?.id === item.id ? "text-blue-500" : "text-muted-foreground"}`}
                      />
                      <div>
            ...
            {currentPlan ? (
              ...
              >
                <div className="p-6 glass rounded-3xl border border-blue-500/30 bg-blue-500/5">
                  ...
                  <p className="text-sm text-foreground leading-relaxed">
                    {currentPlan.planContent.empatheticSummary}
                  </p>
                </div>
                ...
                <div className="p-6 glass rounded-3xl border border-border">
                  ...
                  <ul className="space-y-3">
                    {currentPlan.planContent.negotiationPoints.map(
                      (point, idx) => (
              ...
              <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center p-8 glass rounded-3xl border border-dashed border-border">
                ...
                <p className="text-sm text-muted-foreground/60 max-w-sm mt-2">
                  Enter your situation on the left to get a personalized
                  strategy.
                </p>
              </div>
            )}
