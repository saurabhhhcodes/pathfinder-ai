    ...
    <div className="container max-w-6xl py-12 px-4 md:px-6">
      <div className="space-y-4 mb-10 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Moving for a new job? Calculate the cost of living difference and
          generate the exact scripts needed to negotiate a relocation bonus or a
                ...
                {history.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Home
                        className={`h-4 w-4 shrink-0 ${currentAnalysis?.id === item.id ? "text-orange-500" : "text-muted-foreground"}`}
                      />
                      <div className="min-w-0">
                        <p className="text-sm font-bold text-foreground truncate">
                          {item.currentCity} → {item.targetCity}
                        </p>
            ...
            {currentAnalysis ? (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 glass rounded-3xl border border-orange-500/30 bg-orange-500/5">
                    ...
                    <p className="text-xl font-bold text-foreground">
                      {currentAnalysis.analysisData.costOfLivingDelta}
                    </p>
                  </div>
                  ...
                  <div className="p-6 glass rounded-3xl border border-emerald-500/30 bg-emerald-500/5">
                    ...
                    <p className="text-xl font-bold text-foreground">
                      {currentAnalysis.analysisData.equivalentSalary}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 glass rounded-3xl border border-border">
                  ...
                  <ul className="space-y-3">
                    {currentAnalysis.analysisData.hiddenCosts.map(
                      (cost, idx) => (
                        <li key={idx} className="flex items-start gap-3">
                          <span className="text-rose-500 mt-1 font-bold">
                            •
                          </span>
              ...
              <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center p-8 glass rounded-3xl border border-dashed border-border">
                ...
                <p className="text-sm text-muted-foreground/60 max-w-sm mt-2">
                  Compare your current city to your target destination to get
                  negotiation data.
                </p>
              </div>
            )}
