    ...
    <div className="container max-w-6xl py-12 px-4 md:px-6">
      <div className="space-y-4 mb-10 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Input your professional skills and personal interests. We'll generate
          hyper-specific micro-businesses or side hustles you can start this
          weekend.
        </p>
      </div>
                ...
                {history.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Compass
                        className={`h-4 w-4 shrink-0 ${currentIdeas?.id === item.id ? "text-cyan-500" : "text-muted-foreground"}`}
                      />
            ...
            {currentIdeas ? (
              ...
              >
                {currentIdeas.ideasData.ideas.map((idea, idx) => (
                  <div
                    key={idx}
                    className="p-6 glass rounded-3xl border border-border group relative overflow-hidden transition-all hover:border-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/5"
                  >
              ...
              <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center p-8 glass rounded-3xl border border-dashed border-border">
                ...
                <p className="text-sm text-muted-foreground/60 max-w-sm mt-2">
                  Enter your skills and interests to get customized
