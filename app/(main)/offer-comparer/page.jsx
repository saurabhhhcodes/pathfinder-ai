...
export default function OfferComparerPage() {
  ...
  const addOffer = () => {
    ...
    setOffers([
      ...offers,
      { id: Date.now(), company: "", baseSalary: "", bonus: "", equity: "" },
    ]);
  };
        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm md:text-base font-medium">
              Calculate total compensation and get strategic advice on which
              offer to accept.
            </p>
          </div>
        </motion.div>
            ...
            <div className="bg-card border border-border p-6 md:p-8 rounded-3xl shadow-sm space-y-8">
              ...
              <div className="space-y-6">
                {offers.map((offer, index) => (
                  <div
                    key={offer.id}
                    className="relative bg-muted/30 p-5 rounded-2xl border border-border"
                  >
                    {offers.length > 2 && (
                      <button
                    ...
                    <h4 className="text-sm font-bold uppercase tracking-widest text-emerald-500 mb-4">
                      Offer {index + 1}
                    </h4>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          value={offer.bonus}
                          onChange={(e) =>
                            handleUpdateOffer(offer.id, "bonus", e.target.value)
                          }
                        />
                      </div>
                      <div className="space-y-2 col-span-2">
                        <label className="text-xs font-semibold text-muted-foreground flex items-center gap-1.5">
                          <TrendingUp className="h-3.5 w-3.5" /> Equity / RSUs
                          (Annual $)
                        </label>
                        <Input
                          type="number"
              ...
              >
                {loading ? "Analyzing..." : "Compare & Evaluate"}{" "}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                              Base: {formatCurrency(offer.baseSalary || 0)}
                            </p>
                          </div>
                        </div>
              ...
              <div className="h-full flex items-center justify-center p-12 border-2 border-dashed border-border rounded-3xl text-center">
                <div className="max-w-md space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Enter the financial details of your job offers on the left,
                    and the AI will calculate the true total compensation and
