        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm md:text-base font-medium">
              Generate highly personalized networking and outreach emails in
              seconds.
            </p>
          </div>
        </motion.div>
            ...
            <div className="bg-card border border-border p-6 rounded-3xl shadow-sm">
              ...
              <form onSubmit={handleGenerate} className="space-y-5">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider ml-1 flex items-center gap-1.5">
                      <MessageSquareText className="h-3.5 w-3.5" /> Additional
                      Context (Optional)
                    </label>
                    <Textarea
                ...
                >
                  {loading ? "Drafting..." : "Generate Outreach Emails"}{" "}
                ...
                <div className="flex items-center justify-between border-b border-border/50 pb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      {activeEmail.goal} •{" "}
                      {activeEmail.recipientName || "Hiring Manager"} at{" "}
                      {activeEmail.company || "Company"}
                    </p>
                  </div>
                  <button
              ...
              <div className="h-full flex items-center justify-center p-12 border-2 border-dashed border-border rounded-3xl text-center">
                <div className="max-w-md space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Fill out the outreach details on the left to generate
                    customized, high-converting networking emails.
                  </p>
                </div>
              </div>
            )}
