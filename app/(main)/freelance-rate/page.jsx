    ...
    <div className="container max-w-6xl py-12 px-4 md:px-6">
      <div className="space-y-4 mb-10 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Going independent? Calculate your optimal hourly or project-based
          rate, and get the exact scripts you need to justify your pricing to
                ...
                {history.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <HandCoins
                        className={`h-4 w-4 shrink-0 ${currentRate?.id === item.id ? "text-emerald-500" : "text-muted-foreground"}`}
                      />
                      <div className="min-w-0">
                        <p className="text-sm font-bold text-foreground truncate">
                          Target: {item.targetIncome}
                        </p>
            ...
            {currentRate ? (
              ...
              >
                ...
                <div className="p-6 glass rounded-3xl border border-emerald-500/30 bg-emerald-500/5 text-center">
                  ...
                  <p className="text-5xl font-black text-foreground">
                    {currentRate.rateData.calculatedHourlyRate}
                  </p>
                </div>
              ...
              <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center p-8 glass rounded-3xl border border-dashed border-border">
                ...
                <p className="text-sm text-muted-foreground/60 max-w-sm mt-2">
                  Enter your skills and income goals to discover your true
                  market value.
                </p>
              </div>
            )}
