...
const TECH_FALLBACK_QUESTIONS = [
  {
    ...
    explanation:
      "HTML (Hyper Text Markup Language) is the standard markup language used to structure and display web pages.",
  },
  {
    ...
    explanation:
      "JavaScript is a high-level, interpreted scripting language that conforms to the ECMAScript specification and runs natively inside all modern browsers.",
  },
  {
    ...
    explanation:
      "React is a popular open-source JavaScript library developed by Meta specifically for building component-based frontend user interfaces.",
  },
  {
    ...
    explanation:
      "MongoDB is a leading document-oriented NoSQL database that stores data in JSON-like flexible documents.",
  },
  {
    ...
    explanation:
      "CSS (Cascading Style Sheets) is a stylesheet language used to specify the layout, colors, fonts, and overall visual appearance of HTML documents.",
  },
  {
    question:
      "Which hook is commonly used to manage state inside a React function component?",
    options: ["useEffect", "useFetch", "useState", "useRouter"],
    correctAnswer: "useState",
    explanation:
      "The useState hook is a built-in React hook that allows functional components to have local state variables that persist across renders.",
  },
  {
    ...
    explanation:
      "Node.js is a cross-platform, open-source JavaScript runtime environment built on Chrome's V8 engine that allows developers to run JS code server-side.",
  },
  {
    ...
    explanation:
      "Java was originally developed and released by James Gosling and his team at Sun Microsystems in 1995 (later acquired by Oracle).",
  },
  {
    ...
    explanation:
      "An API (Application Programming Interface) is a set of defined rules and protocols that enables different software applications to communicate and exchange data.",
  },
  {
    question:
      "Which keyword is used to declare a variable in older JavaScript scopes that is function-scoped?",
    options: ["define", "string", "var", "integer"],
    correctAnswer: "var",
    explanation:
      "In JavaScript, 'var' is the original keyword used to declare variables. It is function-scoped rather than block-scoped like 'let' and 'const'.",
  },
];
...
const HEALTHCARE_FALLBACK_QUESTIONS = [
  {
    ...
    explanation:
      "HIPAA (Health Insurance Portability and Accountability Act) sets national standards for protecting sensitive patient health information from being disclosed without the patient's consent or knowledge.",
  },
  {
    question:
      "What does the acronym 'EHR' stand for in healthcare administration?",
    options: [
    ...
    explanation:
      "An Electronic Health Record (EHR) is a digital version of a patient's paper chart, containing real-time, patient-centered records that make information available instantly and securely.",
  },
  {
    ...
    explanation:
      "Family Medicine Physicians provide comprehensive, continuous primary healthcare for individuals and families across all ages, genders, and diseases.",
  },
  {
    ...
    correctAnswer:
      "The process of prioritizing patients based on the severity of their condition",
    explanation:
      "Triage is the prioritization of patient care based on clinical urgency to optimize resource allocation and ensure critical patients receive immediate care.",
  },
  {
    ...
    explanation:
      "Myocardial infarction is the medical term for a heart attack, which occurs when blood flow to a part of the heart muscle is blocked, causing tissue damage.",
  },
  {
    question:
      "Which professional is responsible for preparing and dispensing prescriptions?",
    options: [
      "Physician Assistant",
      "Pharmacist",
      "Registered Nurse",
    ...
    explanation:
      "Pharmacists are healthcare professionals who specialize in the right use, storage, preservation, and dispensing of medicines.",
  },
  {
    ...
    explanation:
      "Nosocomial infections (also called healthcare-associated infections) are those contracted by patients during their stay in a hospital or healthcare facility.",
  },
  {
    ...
    explanation:
      "Red blood cells contain hemoglobin, a protein that binds to oxygen in the lungs and transports it to tissues throughout the body.",
  },
  {
    question: "What does the term 'benign' mean in medical pathology?",
    options: ["Spreading rapidly", "Non-cancerous", "Infectious", "Painful"],
    correctAnswer: "Non-cancerous",
    explanation:
      "Benign refers to a condition, tumor, or growth that is not cancerous, does not invade nearby tissue, and does not spread to other parts of the body.",
  },
  {
    ...
    correctAnswer:
      "The remote delivery of healthcare services using telecommunications technology",
    explanation:
      "Telehealth uses digital information and communication technologies (computers, mobile devices) to access and manage healthcare services remotely.",
  },
];
...
const FINANCE_FALLBACK_QUESTIONS = [
  ...
  },
  {
    ...
    explanation:
      "A bond is a fixed-income instrument that represents a loan made by an investor to a borrower (typically corporate or governmental) with fixed interest payments.",
  },
  {
    ...
    explanation:
      "Diversification spreads investments across various financial instruments, industries, and categories to minimize the impact of any single asset's poor performance.",
  },
  {
    ...
    explanation:
      "The Federal Reserve is the central bank of the U.S., responsible for conducting monetary policy and regulating financial institutions to promote economic stability.",
  },
  {
  ...
  },
  {
    ...
    explanation:
      "Liquid assets are cash or other assets (like stocks or short-term bonds) that can be easily and quickly converted into cash without significant loss of value.",
  },
  {
    ...
    correctAnswer:
      "The rate at which the general level of prices for goods and services rises",
    explanation:
      "Inflation is the decline of purchasing power of a given currency over time, reflected in the increase of prices of goods and services.",
  },
  {
  ...
  },
  {
    ...
    correctAnswer:
      "Revenue is total sales; net income is profit after all expenses",
    explanation:
      "Revenue represents the total money brought in by sales, whereas net income is the profit remaining after deducting all operating costs, taxes, and expenses.",
  },
  {
    ...
    explanation:
      "Amortization is the practice of spreading out a loan into a series of periodic payments, or writing off the value of an intangible asset over time.",
  },
];
...
const BUSINESS_FALLBACK_QUESTIONS = [
  {
    ...
    explanation:
      "A SWOT analysis is a strategic planning framework used to identify and analyze internal and external factors affecting a business's projects.",
  },
  {
    ...
    correctAnswer:
      "A tangible or intangible good or service produced as a result of a project",
    explanation:
      "Deliverables are the quantifiable goods or services that must be completed and delivered to a client or stakeholder upon a project's completion.",
  },
  {
    ...
    explanation:
      "B2B (Business-to-Business) describes transactions or commerce conducted between one business and another, rather than between a business and individual consumers.",
  },
  {
  ...
  },
  {
    ...
    explanation:
      "A Key Performance Indicator (KPI) is a quantifiable measure used to evaluate the success of an organization or activity in meeting performance objectives.",
  },
  {
    ...
    correctAnswer:
      "Uncontrolled changes or continuous growth in a project's scope",
    explanation:
      "Scope creep refers to when a project's requirements expand beyond the original plan without corresponding adjustments in time, budget, or resources.",
  },
  {
    ...
    correctAnswer:
      "Dividing a market into distinct groups of buyers based on different needs or characteristics",
    explanation:
      "Market segmentation involves dividing a broad target market into subsets of consumers who have common needs or priorities, then designing strategies to target them.",
  },
  {
    ...
    correctAnswer:
      "Protecting proprietary or confidential information from being shared",
    explanation:
      "An NDA is a legal contract that prohibits parties from sharing confidential information or trade secrets disclosed to them with external entities.",
  },
  {
    ...
    correctAnswer:
      "The total cost associated with convincing a customer to buy a product or service",
    explanation:
      "CAC measures the total sales and marketing cost required to acquire a single new customer over a specific period.",
  },
  {
    ...
    explanation:
      "An RFP is a document that solicits proposals, often made through a bidding process, by an agency or company interested in procurement of services or assets.",
  },
];
...
export async function generateQuiz(category = "Technical") {
  try {
    ...
    if (!categoryValidation.success)
      return { success: false, errors: categoryValidation.errors };

    const quizLimit = await checkRateLimit(userId, "quiz");
    if (!quizLimit.allowed) {
      throw new Error(
        `Quiz generation limit reached. Resets in ${formatResetTime(quizLimit.resetAt)}.`,
      );
    }
    ...
    const categoryPrompts = {
      Technical:
        "Generate 10 technical interview questions focusing on programming concepts, data structures, system design, algorithms, and practical technical knowledge.",
      Behavioral:
        "Generate 10 behavioral interview questions focusing on teamwork, leadership, conflict resolution, communication, and past experiences. Use scenarios like 'Tell me about a time when...' or 'How would you handle...'",
      Situational:
        "Generate 10 situational interview questions focusing on hypothetical workplace scenarios - how the candidate would handle specific on-the-job situations, ethical dilemmas, and decision-making.",
      "Industry Knowledge":
        "Generate 10 industry knowledge interview questions focusing on domain trends, terminology, business context, and role-specific professional awareness.",
    };
...
Generate EXACTLY 10 UNIQUE MCQ questions.`,
      untrustedData: [
        {
          label: "industry",
          value: user.industry || "software",
          maxLength: 200,
        },
        {
          label: "skills",
          value: normalizedSkills.join(", ") || "Not specified",
          maxLength: 1000,
        },
...

{
  "questions": [
    ...
    try {
      ...
      const quizValidation = validateOutput(
        interviewQuestionsOutputSchema,
      ...
      console.error(
        "AI Quiz generation failed, using fallback questions:",
        error,
      );
      const industryId = user.industry?.split("-")[0]?.toLowerCase() || "tech";
      const fallbackQuestions =
        FallbackQuizPool[industryId] || TECH_FALLBACK_QUESTIONS;
...
export async function saveQuizResult(
  ...
  try {
    ...
    const validation = validateInput(quizResultSaveSessionSchema, {
      sessionId,
      answers,
      category,
    });
    ...
    if (!feedbackLimit.allowed) {
      throw new Error(
        `Quiz feedback limit reached. Resets in ${formatResetTime(feedbackLimit.resetAt)}.`,
      );
    }
    ...
    if (wrongAnswers.length > 0) {
      ...
      try {
        ...
        const industryText = user.industry
          ? `in ${user.industry.toLowerCase()}`
          : "in your field";
...
export async function evaluateVoiceAnswer(question, transcribedAnswer) {
  ...
  const prompt = buildSecurePrompt({
    context:
      "You are an expert interview coach evaluating a spoken answer from a candidate.",
    ...
    outputRules: `Provide feedback in JSON format ONLY. Do not output any markdown code fences or extra text:
{
  ...
  try {
    ...
    if (!validation.success) {
      console.error(
        "Voice evaluation output validation failed:",
        validation.errors,
      );
...
export async function evaluateVideoAnswer(
  ...
  const prompt = buildSecurePrompt({
    context:
      "You are an expert interview coach evaluating a video interview response.",
    ...
    outputRules: `Provide feedback in JSON format ONLY. Do not output any markdown code fences or extra text:
{
  ...
  try {
    ...
    if (!validation.success) {
      console.error(
        "Video evaluation output validation failed:",
        validation.errors,
      );
      return { success: false, error: "AI returned an unexpected format." };
    }
